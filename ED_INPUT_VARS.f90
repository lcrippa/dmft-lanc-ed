...
contains
  ...
  subroutine ed_read_input(INPUTunit,comm)
    ...
    call parse_input_variable(cg_grad,"CG_GRAD",INPUTunit,default=0,comment="Gradient evaluation method: 0=analytic (default), 1=numeric (required for bath_type=replica).")    
